using MarcoParenzan.Office365.API.Controllers;
...
namespace MarcoParenzan.Office365.API.Models
{
    public abstract class Office365ServiceInfo
    {
        ...
        /// should issue an OAuth request using the Office365Controller.GetAuthorizationUrl function
        /// </summary>
        ...
        {
            return Office365Controller.GetAuthorizationUrl(ResourceId, redirectTo);
        }
        ...
        ///     obtained using Office365Controller's GetAuthorizationUrl function.
        /// </summary>
        ...
        private class ActiveDirectoryServiceInfo : Office365ServiceInfo
        {
            internal ActiveDirectoryServiceInfo()
            {
                ...
                AccessToken = Office365Controller.GetAccessToken(ResourceId);
            }
        ...
        private class SharePointOneDriveServiceInfo : Office365ServiceInfo
        {
            ...
            internal static async Task<Office365ServiceInfo> CreateAsync()
            {
                ...
                {
                    ResourceId = (string)Office365Controller.GetFromCache("SharePointOneDriveResourceId"),
                    ApiEndpoint = (string)Office365Controller.GetFromCache("SharePointOneDriveApiEndpoint")
                };
                ...
                {
                    info.AccessToken = Office365Controller.GetAccessToken(info.ResourceId);
                    return info;
                }
                ...
                //        "/_api/Web/GetFolderByServerRelativeUrl('/personal/marco_parenzan_maker365_onmicrosoft_com/Documents')";
                info.ApiEndpoint = myFilesEndpoint.ServiceEndpointUri;
                Office365Controller.SaveInCache("SharePointOneDriveResourceId", info.ResourceId);
                Office365Controller.SaveInCache("SharePointOneDriveApiEndpoint", info.ApiEndpoint);
                info.AccessToken = Office365Controller.GetAccessToken(info.ResourceId);
                return info;
            }
            ...
            public override string GetAuthorizationUrl(Uri redirectTo)
            {
                ...
                return Office365Controller.GetAuthorizationUrl(resourceIdForAuthRequest, redirectTo);
            }
